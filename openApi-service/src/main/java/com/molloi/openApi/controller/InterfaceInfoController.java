...
import com.molloi.openApi.common.*;
import com.molloi.openApi.constant.CommonConstant;
import com.molloi.openApi.constant.UserConstant;
import com.molloi.openApi.dto.interfaceInfo.InterfaceInfoAddRequest;
import com.molloi.openApi.dto.interfaceInfo.InterfaceInfoInvokeRequest;
import com.molloi.openApi.dto.interfaceInfo.InterfaceInfoQueryRequest;
import com.molloi.openApi.dto.interfaceInfo.InterfaceInfoUpdateRequest;
...
import com.molloi.openApi.model.enums.InterfaceInfoStatusEnum;
import com.molloi.openApi.service.InterfaceInfoService;
import com.molloi.openApi.service.UserService;
...
//        queryWrapper.like(StringUtils.isNotBlank(content), "content", content);
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest, HttpServletRequest request) {
        ...
        // 判断接口是否能被调用
        com.molloi.openapiclientsdk.model.User user = new com.molloi.openapiclientsdk.model.User();
        user.setUserName("poiij");
        String body = apiClient.getUserNameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(userRequestParams) || id < 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        // 判断接口是否存在
        InterfaceInfo oldInterfaceInfo = interfaceInfoService.getById(id);
